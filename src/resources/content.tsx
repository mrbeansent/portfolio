...
const person: Person = {
  firstName: "Amiel Vincent",
  lastName: "Canas",
  name: `Amiel Vincent Canas`,
  role: "Design Engineer",
  avatar: "/images/avatar.jpeg",
  email: "vincentcanas@gmail.com",
...
const social: Social = [
  ...
  // Set essentials: true for links you want to show on the about page
  {
    name: "GitHub",
    icon: "github",
    link: "https://github.com/mrbeansent",
    essential: true,
  },
  {
    name: "LinkedIn",
    icon: "linkedin",
    link: "https://www.linkedin.com/in/amiel-vincent-canas/",
    essential: true,
  },
  {
    name: "Instagram",
...
const about: About = {
  ...
  intro: {
    ...
    description: (
      <>
        Amiel Vincent is a PH-based design engineer with a passion for transforming complex challenges
