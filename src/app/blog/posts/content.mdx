...
`const home = {
    label: "Home",
    title: "Amiel Vincent Canas's Portfolio",
    description: "Portfolio website showcasing my work as a Web Developer & Project Manager",
    headline: <>Design engineer and builder</>,
    subline: (
      <>
        I'm Vincent, a design engineer at <InlineCode>FLY</InlineCode>, where I craft intuitive
